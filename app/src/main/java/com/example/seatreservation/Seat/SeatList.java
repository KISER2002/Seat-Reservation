...
public class SeatList extends AppCompatActivity implements OnListItemSelectedInterface {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                SeatAdapter adapter = new SeatAdapter(SeatList.this, seatList, SeatList.this);
